...
exp 
    : TK_ID TK_OP_ATRIB factor %prec TK_OP_ATRIB  { $$.traducao = $1.label + " = " + $3.traducao; }
...
comandoIO
    : /* vazio */                             { $$.traducao = ""; }
    | TK_ESCREVA TK_OP explist TK_CP endline  { $$.traducao = "printf(" + $3.traducao + ");"; }
    | TK_ESCREVAL TK_OP explist TK_CP endline { $$.traducao = "printf(" + $3.traducao + "\\n);"; }
    | TK_LEIA TK_OP TK_ID TK_CP endline       { $$.traducao = "scanf(\"%d\", &" + $3.label + ");"; }
    ;
