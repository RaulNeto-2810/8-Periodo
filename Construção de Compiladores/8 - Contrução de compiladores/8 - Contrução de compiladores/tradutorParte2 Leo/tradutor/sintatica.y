...
lstids 
    : /* vazio */                         { $$.traducao = ""; }
	| TK_ID TK_VIRGULA TK_ID lstids TK_OP_VAR tipo endline
        {
            $$.traducao = $6.traducao + " " + $1.label + ", " + $3.label + $4.traducao + ";";
        }
    | TK_ID TK_OP_VAR tipo endline lstids { $$.traducao = $3.traducao + " " + $1.label + ";" + $4.traducao + $5.traducao; }
...
tipo
    ...
    | TK_TIPO_LOGICO   { $$.traducao = "bool"; } // adicionei "bool" para tipo lógico
...
bloco_subalgo
    : /* vazio */                { $$.traducao = ""; }
    | subalgoritmo bloco_subalgo { $$.traducao = $1.traducao + "\n" + $2.traducao; }
    ;
...
subalgoritmo
    ...
    | TK_FUNCAO TK_ID TK_OP arglist TK_CP auxfuncao 
      bloco_var 
      TK_INICIO TK_NL 
      auxfuncao2 
      TK_FIMFUNCAO TK_NL endline 
      { 
...
auxfuncao
    ...
    | tipo endline { $$.traducao = $2.traducao; }
    ;
...
retornofuncao
    : TK_RETORNE endline     { $$.traducao = "return;\n"; }
    | TK_RETORNE exp endline { $$.traducao = "return " + $2.traducao + ";\n"; }
    ;
...
comandos
	: /* vazio */      { $$.traducao = ""; }
    | comando endline  { $$.traducao = $1.traducao + $2.traducao; }
    | comandos comando { $$.traducao = $1.traducao + $2.traducao ;}
	;
...
comando
    ...
    { 
        $$.traducao = "for (" + $4.label + "; " + $6.label + "; " + $7.traducao + ") {\n" + $11.traducao + "\n}"; 
    }
...
passovariacao
    : /* vazio */ { $$.traducao = ""; }
    | TK_PASSO TK_NUM_INT { $$.traducao = $1.label + $2.label; }
    | TK_PASSO TK_OP_SUB TK_NUM_INT %prec TK_UMINUS { $$.traducao = $1.label + " - " + $2.label; }
    ;
...
constantlist
    ...
    | constant TK_VIRGULA constantlist { $$.traducao = $1.traducao + ", " + $3.traducao; }
    ;

constant
    : TK_NUM                        { $$.traducao = $1.label; }
    | TK_NUM_INT                    { $$.traducao = $1.label; }
    | TK_ID                         { $$.traducao = $1.label; }
    | VLR_STRING                    { $$.traducao = $1.label; }
    | VLR_CHARACTER                 { $$.traducao = $1.label; }
    | TK_CONST_FALSO                { $$.traducao = "false"; }
    | TK_CONST_VERDADEIRO           { $$.traducao = "true"; }
    ;
...
exp 
	: TK_ID TK_OP_ATRIB factor %prec TK_OP_ATRIB  { $$.traducao = $1.label + "=" + $3.traducao ;} // atribuições
	...
	| TK_OP_NAO         exp { $$.traducao = $1.traducao + "!" + $2.traducao ;}
...
factor
	...
	| exp TK_OP_DIV_INT factor { $$.traducao = $1.traducao + " " + "\\" + $3.traducao;}
    | exp TK_OP_EXP     factor { $$.traducao = $1.traducao + " " + "pow" + $3.traducao;}
	;
...
comandoIO
  ...
  | TK_ESCREVA TK_OP explist TK_CP endline  
    { $$.traducao = "print(" + $3.traducao + ")"; }
  | TK_ESCREVAL TK_OP explist TK_CP endline 
    { $$.traducao = "println(" + $3.traducao + ")"; }
  | TK_LEIA TK_OP TK_ID TK_CP endline       
    { $$.traducao = "scanf(\"%i\", &" + $3.label + ")"; }
  ;

predefinedFuncions
  : /* vazio */                                            { $$.traducao = ""; }
  | TK_ABS TK_OP exp TK_CP                                 
    { $$.traducao = "abs(" + $3.traducao + ")"; } 
  | TK_ARCCOS TK_OP exp TK_CP                              
    { $$.traducao = "arccos(" + $3.traducao + ")"; } 
  | TK_ARCSEN TK_OP exp TK_CP                              
    { $$.traducao = "arcsen(" + $3.traducao + ")"; } 
  | TK_ARCTAN TK_OP exp TK_CP                              
    { $$.traducao = "arctan(" + $3.traducao + ")"; } 
  | TK_ASC TK_OP exp TK_CP                                 
    { $$.traducao = "asc(" + $3.traducao + ")"; }    
  | TK_COMPR TK_OP exp TK_CP                               
    { $$.traducao = "compr(" + $3.traducao + ")"; }   
  | TK_COPIA TK_OP exp TK_VIRGULA exp TK_VIRGULA exp TK_CP 
    { $$.traducao = "copia(" + $3.traducao + ", " + $5.traducao + ", " + $7.traducao + ")"; }   
  | TK_COS TK_OP exp TK_CP                                 
    { $$.traducao = "cos(" + $3.traducao + ")"; }
  | TK_COTAN TK_OP exp TK_CP                               
    { $$.traducao = "cotan(" + $3.traducao + ")"; } 
  | TK_EXP TK_OP exp TK_VIRGULA exp TK_CP                  
    { $$.traducao = "exp(" + $3.traducao + ", " + $5.traducao + ")"; }     
  | TK_GRAUPRAD TK_OP exp TK_CP                            
    { $$.traducao = "grauprad(" + $3.traducao + ")"; }
  | TK_FUN_INT TK_OP exp TK_CP                             
    { $$.traducao = "int(" + $3.traducao + ")"; }
  | TK_INTERROMPA                                          
    { $$.traducao = "break"; }
  | TK_LOG TK_OP exp TK_CP                                 
    { $$.traducao = "log(" + $3.traducao + ")"; }    
  | TK_LOGN TK_OP exp TK_CP                                
    { $$.traducao = "logn(" + $3.traducao + ")"; }   
  | TK_MAIUSC TK_OP exp TK_CP                              
    { $$.traducao = "maiusc(" + $3.traducao + ")"; }  
  | TK_MINUSC TK_OP exp TK_CP                              
    { $$.traducao = "minusc(" + $3.traducao + ")"; } 
  | TK_NUMPCARAC TK_OP exp TK_CP                           
    { $$.traducao = "numpcarac(" + $3.traducao + ")"; }
  | TK_PI                                                  
    {
      double pi = 3.14159265358979323846; 
      $$.traducao = std::to_string(pi);
    }
  | TK_POS TK_OP exp TK_VIRGULA exp TK_CP                  
    { $$.traducao = "pos(" + $3.traducao + ")"; }    
  | TK_QUAD TK_OP exp TK_CP                                
    { $$.traducao = "quad(" + $3.traducao + ")"; }
  | TK_RADPGRAU TK_OP exp TK_CP                            
    { $$.traducao = "radpgrau(" + $3.traducao + ")"; }
  | TK_RAIZQ TK_OP exp TK_CP                               
    { $$.traducao = "sqrt(" + $3.traducao + ")"; }   
  | TK_RAND                                               
    { $$.traducao = "rand"; }    
  | TK_RANDI TK_OP exp TK_CP                               
    { $$.traducao = "randi(" + $3.traducao + ")"; }  
  | TK_SEN TK_OP exp TK_CP                                 
    { $$.traducao = "sen(" + $3.traducao + ")"; }
  | TK_TAN TK_OP exp TK_CP                                 
    { $$.traducao = "tan(" + $3.traducao + ")"; }    
